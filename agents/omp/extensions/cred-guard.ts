/**
 * Credential Guard Extension (omp)
 *
 ...
 * is shared with the Claude Code PreToolUse hook and Pi extension.
 *
 ...
 *
 * Place in ~/.omp/agent/extensions/ for global protection across all projects.
 */
...
function loadPatterns(): CredGuardPatterns {
	// Resolve shared/patterns/cred-guard.json. Install copies this to
	// ~/.omp/agent/patterns/. Search there first, then fall back to a
	// path relative to this file (for local dev).
	const candidates = [
		"/home/agent/.omp/agent/patterns/cred-guard.json",
